...
public class JsonApiBodyRequest   {
  ...
  public JsonApiBodyRequest addNegocioItem(RegistrarRequest negocioItem) {
    if (this.negocio == null) {
      this.negocio = new ArrayList<RegistrarRequest>();
    }
  ...
  **/
  ...
  public void setPersona(List<RegistrarRequest> negocio) {
    this.negocio = negocio;
  }
  ...
  public String toString() {
    ...
    sb.append("    persona: ").append(toIndentedString(negocio)).append("\n");
    sb.append("}");
    return sb.toString();
  }
