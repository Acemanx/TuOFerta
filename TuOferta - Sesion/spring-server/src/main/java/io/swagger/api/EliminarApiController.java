...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2018-08-06T15:47:19.179Z")
...
public class EliminarApiController implements EliminarApi {
    ...
    public ResponseEntity<JsonApiBodyResponseSuccess> eliminarIdnegocioDelete(@ApiParam(value = "ID del negocio",required=true) @PathVariable("idnegocio") String idnegocio) {
